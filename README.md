...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ih4org0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ih4org0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Srikar04/container-ih4org0.git
cd container-ih4org0
```
...
```
docker attach container-ih4org0
```
